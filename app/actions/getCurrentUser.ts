...
const getCurrentUser = async () => {
  try {
    ...
    // route.tsで設定したnextAuthOptionsオブジェクトを引数に取る
    // セッション情報はnextAuthOptionsの設定に従って、作成されるデータなのでnextAuthOptionsを引数に取る
    // getServerSession関数はnextAuthOptionsを参照しながらデータを取得する
